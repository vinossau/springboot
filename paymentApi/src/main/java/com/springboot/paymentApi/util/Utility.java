package com.springboot.paymentApi.util;
...
public class Utility {
    ...
    private static final char[] PASSWORD = "paymentapi".toCharArray();
    ...
    private static final String RECEIVER_KEYSTORE = "receiver_keytore.p12";
